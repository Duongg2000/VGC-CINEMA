...
<body>
	...
	<div class="container">
		...
		<nav>
            ...
            l = s.getFilmStatistic(sDate, eDate);
            
                 
             %>
             
            <form action="FilmStatisticView.jsp" method="post"  >
                <fieldset>
                   <table >
                    ...
                    <div style="padding: 10px;">THỐNG KÊ PHIM</div>
                </fieldset>
            </form>
             ...
             <table class="table"> 
                 ...
                 <%
                     ...
                     for(int i=0; i<l.size();i++){
                        ...
                        <td >
                        <button class="btn btn-dark" onclick="window.open('FilmStatisticDetailView.jsp?filmId=<%=l.get(i).getId()%>&sDate=<%=sDate%>&eDate=<%=eDate%>', '_self')"  >Xem chi tiết
                        </button>
                        </td>
